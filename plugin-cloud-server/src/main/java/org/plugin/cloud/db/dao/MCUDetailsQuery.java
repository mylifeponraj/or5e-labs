...
public interface MCUDetailsQuery {
	...
	public static final String INSERT_MCU = "insert into masterunitcontroller (masterunitname, masterunitmacid, masterunitipaddr, masterunitsoftwareversion, masterunitstatus, userid, masterunitlicense) values (?,?,?,?,?,?,?)";
}
