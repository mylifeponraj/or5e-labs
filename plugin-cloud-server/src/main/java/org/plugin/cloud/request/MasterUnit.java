...
public class MasterUnit {
	...
	public String masterUnitIPaddr;
	...
	public String getMasterUnitIPaddr() {
		return masterUnitIPaddr;
	}
	public void setMasterUnitIPaddr(String masterUnitIPaddr) {
		this.masterUnitIPaddr = masterUnitIPaddr;
	}
